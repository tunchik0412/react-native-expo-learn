...
const useNotifications = (props?: useNotificationsProps ) => {
    ...
    const schedulePushNotification = async (request?: NotificationRequestInput) => {
    ...
    useEffect(() => {
        ...
        const data = Notifications.addNotificationReceivedListener(notification => {
